...
*/
    ...
    ->setCellValue('A1', 'PROMUJER')
    ->setCellValue('K1', 'INNOVASALUD')
    ->setCellValue('F2', 'REPORTE CONSOLIDADO DE VENTAS')
    ->setCellValue('A3', 'Usuario: ' . $nombre_usuario)
    ->setCellValue('A4', $mensaje)
    ->setCellValue('L3', 'Fecha Inicio: ' . $f_ini)
    ->setCellValue('L4', 'Fecha Fin    : ' . $f_fin);
	...
	$objPHPExcel->getActiveSheet()->setCellValue('A6', "#")
				  ...
				  ->setCellValue('H6', "COBRANZA")
                                  ...
                                  ->setCellValue('K6', "CI ASESOR")
                                  ->setCellValue('L6', "VENDEDOR")
                                  ->setCellValue('M6', "ESTADO");
	...
	//$objPHPExcel->getActiveSheet()->getStyle($cell)->applyFromArray(['alignment' => $alignment]);
		...
		$objPHPExcel->getActiveSheet()->setCellValue('K'.$fila, $row['cedula_asesor']);
		$objPHPExcel->getActiveSheet()->setCellValue('L'.$fila, $row['usuario']);
		$objPHPExcel->getActiveSheet()->setCellValue('M'.$fila, $row['estado']);
