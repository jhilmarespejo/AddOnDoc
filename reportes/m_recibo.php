...
function obtenerDatosRegistro($db, $id_registro){
	...
	$sql = "SELECT CONCAT(c.nombres, ' ',c.ap_paterno,' ',c.ap_materno) nombre, t.codigo_plan, t.precio, p.descripcion_plan_padre, c.num_documento cedula,t.fecha_cobranzas 
...
if($_GET){
	...
	$pdf->Line(87.00,151.00, 121.00, 151.00, null);
