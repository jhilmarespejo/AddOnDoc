...
switch ($_GET["op"]){
	...
	*/
					//in_array(11,$valores)?$_SESSION['administracion_pm']=1:$_SESSION['administracion_pm']=0;
					//in_array(12,$valores)?$_SESSION['administracion']=1:$_SESSION['administracion']=0;
