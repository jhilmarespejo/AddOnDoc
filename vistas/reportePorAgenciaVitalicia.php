              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <form action='../reportes/reporte_excel_agencia_vit.php' name="formulario" id="formulario" method="POST">
...
?>
<script type="text/javascript" src="scripts/reportePorAgenciaVitalicia.js"></script>
