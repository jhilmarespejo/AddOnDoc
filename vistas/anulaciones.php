...
if(isset($_SESSION['login']) && ($_SESSION['anulacion'] == 1)){
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Anulaciones </h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <form action='../reportes/reporte_excel_general.php' name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <label for="fecha_inicio">Fecha Acual</label>
                            <input type="date" class="form-control" name="fecha_inicio" id="fecha_inicio" value="<?php echo date("Y-m-d"); ?>" readonly>
                          </div>
                          <!-- <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
...
?>
<script type="text/javascript" src="scripts/anulaciones.js"></script>
