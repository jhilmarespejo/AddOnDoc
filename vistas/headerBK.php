      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">       
          ...
          <?php 
            ...
            <?php 
            /* if ($_SESSION['vendedor']==99)
            {
              echo '<li id="mRegistro" class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li id="lAdmision"><a href="admision.php"><i class="fa fa-user-md"></i> Admision</a></li>
              </ul>
              <ul class="treeview-menu">
                <li id="lCobranzas"><a href="cobranzas.php"><i class="fa fa-circle-o"></i> Cobranzas</a></li>
              </ul>
            </li>';
            } */
            ?>
